...
{
	const XGameplayTags& GameplayTags = XGameplayTags::GetInstance();
...
#pragma region Secondary Attribute
	...
	TagsToAttributes.Add(GameplayTags.Attributes_Secondary_HealthRegeneration, GetHealthAttribute);
